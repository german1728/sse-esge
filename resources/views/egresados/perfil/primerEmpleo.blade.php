...
@section('breadcrumb')
@include('partials.breadcrumb', ['btext' => 'Mi primer empleo','bicon' => 'fa-home','bindex' => 'Perfil'])
@endsection
...
<div class="tile mt-3 ">
	...
	<div class="clearfix row">
		...
		<div class="column content content-lg col-12 col-lg-8">
			<form method="POST" action="{{url('perfil/primerEmpleo')}}">
				...
				<div class="form-group-estudios">
					...
					@else
					<input type="tel" name="telefono" id="telefono" class="form-control" placeholder="Agregar teléfono"
				...
				<div class="form-group-estudios">
					...
					@else
					<input type="text" name="posgrado" id="posgrado" class="form-control" placeholder="Agrega motivos"
						required>
					@endif
				</div>
