...
class CreatePrimerEmpleoTable extends Migration
{
    ...
    public function up()
    {
        Schema::create('PrimerEmpleo', function (Blueprint $table) {
            ...
            $table->enum('ingreso_mensual', ['Menor a 1,000.00','De 1,001.00 a 2,500.00','De 2,501.00 a 5,000.00','Mayor a 5,000.00'])->nullable();
            $table->integer('actividad_laboral')->nullable();
            $table->string('factores_contratacion', 500)->nullable();
            $table->string('carencias_basicas', 200)->nullable();
            $table->string('carencias_areas', 200)->nullable();
            $table->string('motivo_no_posgrado', 100)->nullable();
