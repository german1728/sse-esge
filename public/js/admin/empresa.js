$(document).ready(function () {//Comprueba que el documento se cargo correctamente
	...
	$('.btn-showDelete').click(function () {//accedemos a la clase del index. btn-delet
		...
		document.getElementById('e_ruc').innerHTML = '<p class="texto-descripcion">' + empresa.ruc + '</p>';
		...
		document.getElementById('e_distrito').innerHTML = '<p class="texto-descripcion">' + empresa.distrito + '</p>';
		document.getElementById('e_ciudad').innerHTML = '<p class="texto-descripcion">' + empresa.ciudad + '</p>';
		document.getElementById('e_departamento').innerHTML = '<p class="texto-descripcion">' + empresa.departamento + '</p>';
